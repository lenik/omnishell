...
void ExplorerCore::createFragmentView(CreateViewContext* ctx) {
    ...
    // Additional types are available for future mapping:
    // audio:  ultimate/bold/files-folders/audio-file-mp-3.svg
    // video:  block/interface-essential/content/video.svg
