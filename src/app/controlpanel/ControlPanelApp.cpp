...
void ControlPanelApp::createMainWindow() {
    frame_ = new wxFrame(nullptr, wxID_ANY, "Control Panel",
    ...
    categoryList_ = new wxListView(leftPanel, wxID_ANY,
                                    wxDefaultPosition, wxSize(200, 400),
                                    wxLC_LIST | wxLC_SINGLE_SEL);
    
    // Add categories
    categories_ = {
        {"Module Manager", "Manage installed modules", 0},
    ...
    wxStaticText* contentLabel = new wxStaticText(contentPanel_, wxID_ANY, 
...
void ControlPanelApp::OnCategorySelected(wxCommandEvent& event) {
    ...
    if (item != -1 && item < (long)categories_.size()) {
        ...
        if (category == "Module Manager") {
            ...
            wxStaticText* label = new wxStaticText(contentPanel_, wxID_ANY,
...
void ControlPanelApp::OnModuleDoubleClicked(wxCommandEvent& event) {
...
void ControlPanelApp::showModuleManager() {
    ...
    // List all modules
    wxListView* moduleList = new wxListView(contentPanel_, wxID_ANY,
